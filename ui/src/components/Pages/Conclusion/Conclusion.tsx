    ...
    return (
        <div className={styles.wrapper}>
            <div className={styles.content}>
                <h1 className={styles.contentTitle}>TRUE INTEROPERABILITY:<br/> WITH ATOMICITY + PRIVACY +
                    CROSS-TECHNOLOGY + EXTENSIBILITY</h1>
                <img src={FirstScreen} alt="full network first screen"
                     className={`${styles.contentImg} ${styles._first}`}/>
                <img src={SecondScreen} alt="full network second screen"
                     className={`${styles.contentImg} ${styles._second} ${!state.secondLogos && styles.hidden}`}/>
                <img src={ThirdScreen} alt="full network third screen"
                     className={`${styles.contentImg} ${styles._second} ${!state.thirdLogos && styles.hidden}`}/>
            ...
            <div className={`${styles.leftTextContainer}`}>
                ...
                <img className={`${styles.leftText} ${!state.thirdLogos && styles.hidden}`} src={TextLeft}
                     alt={"leftText"}/>
            </div>
            <div className={`${styles.rightTextContainer}`}>
                <img src={TextRight} alt={"leftText"}
                     className={`${styles.rightText} ${!state.thirdLogos && styles.hidden}`}/>
                <img src={Rectangle} alt={"rectangle"} className={`${styles.rectangleRight}`}/>
            </div>
        </div>
    )
}
