...
const Image = {
    ...
    [TransactionStatus.TRANSPARENT_ERROR_ATTEMPT]:TransactionTransparentErrorAttempt,
    [TransactionStatus.TRANSPARENT_FIRST_ERROR_ATTEMPT]: TransactionFirstAllocationAttempt,
