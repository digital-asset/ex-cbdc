...
export function getBalance(balances: Balance[], owner: PartyId, format: (number) => string, label: string): {label: string, value: string} {
...
export function getBalances(assetDeposits: readonly CreateEvent<AssetDeposit>[]): Balance[][] {
