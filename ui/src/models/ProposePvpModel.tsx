...
export const disabledPvpStatuses = [ProposeStatusType.AWAITING_RESPONSE, ProposeStatusType.AWAIT_ALLOCATION, ProposeStatusType.ACCEPTED]
export const disabledAllocateStatuses = [ProposeStatusType.AWAITING_RESPONSE, '', ProposeStatusType.SETTLED]
